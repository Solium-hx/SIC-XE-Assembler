...
struct info_csect{
    ...
    int sectionNo ;
    int length ;
    map<string,info_extdef> EXTDEF_TAB ;
    map<string,info_extref> EXTREF_TAB ;
    info_csect(){
        name="DEFAULT" ;
        LOCCTR="0" ;
        sectionNo=0 ;
...
map<string,info_label> SYMTAB;
map<string,info_opcode> OPTAB;
map<string,info_register> REGTAB;
map<string,info_literal> LITTAB;
map<string,info_blocks> BLOCKS;
map<string,info_csect> CSECT_TAB;

void load_OPTAB(){

  	cout<<"Making OPTAB"<<endl;
...
void start_BLOCKS(){
	...
	BLOCKS["DEFAULT"].startAddr = "00000";
